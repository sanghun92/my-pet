// ** React Imports
import React, { ChangeEvent, ElementType, useEffect, useState } from 'react'; // ** MUI Imports
...
import { BackDropLoading, ContentLoading } from '@/core/components/loading';
...
const TabMemberProfile = () => {
  ...
  const { isLoading: memeStateLoading, data: memberState } = useMemberQuery();
  ...
  return (
    <>
      ...
      {isUpdateLoading && <BackDropLoading open={isUpdateLoading} />}
    </>
  );
};
