...
class CreateMemberEventListenerTest {

    @Mock
    private EmailService emailService;

    @InjectMocks
    private CreateMemberEventListener eventListener;
